...
const CTA = () => {
  return (
    <div>
    <section className='container bg-blue-200 py-14 px-8'>
        <div className='md:max-w-300 mx-auto md:py-20 md:px-8 py-8 px-4 bg-blue-700 rounded-lg shadow-4xl shadow-xl/50 flex flex-col items-center gap-y-2 max-w-150'>
